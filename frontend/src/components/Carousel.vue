      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption anime-highlight">
            ...
            <p class="synopsis">
              The story follows elven mage Frieren, a former member of the party
              of adventurers who defeated the Demon King and restored harmony to
              the world after a ten-years-quest.
            </p>
            <div class="rating">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption anime-highlight">
            ...
            <p class="synopsis">
              ...
              secret organization of Jujutsu Sorcerers to eliminate a powerful
            ...
            <div class="rating">
              ...
              <div>
                <h3 class="rating-title">Rating</h3>
                <h3 class="rating-score">8.7/10</h3>
              </div>
            </div>
            <div class="buttons-info">
              <button class="button-watch">
        ...
        <div class="carousel-item">
          <img src="@/assets/aot.jpg" class="image d-block w-100" alt="..." />
          <div class="carousel-caption anime-highlight">
            <h3 class="season">Final Season</h3>
            <h2>Attack on Titan</h2>
            <p class="synopsis">
              The story follows Eren Yeager, who vows to exterminate the Titans
              after they bring about the destruction of his hometown and the
              death of his mother.
            </p>
            <div class="rating">
              <img class="icon-star" src="../assets/star.png" alt="icon star" />
              <div>
                <h3 class="rating-title">Rating</h3>
                <h3 class="rating-score">8.6/10</h3>
              </div>
            </div>
            <div class="buttons-info">
              <button class="button-watch">
